<template>
  ...
  >
    ...
    <div class="vertical-nav-header d-flex items-center ps-6 pe-5 pt-5 pb-2">
      <router-link to="/" class="d-flex align-center text-decoration-none">
        ...
        <v-slide-x-transition>
          <h2 class="app-title primary--text">BEAUTIFY</h2>
        </v-slide-x-transition>
      </router-link>
    </div>
    ...
    <v-list expand shaped class="vertical-nav-menu-items pr-5">
      ...
      <nav-menu-link title="Charts" :to="{ name: 'charts' }" :icon="icons.mdiChartPie"></nav-menu-link>
      <nav-menu-link
      ...
      <nav-menu-group title="Pages" :icon="icons.mdiFileOutline">
        ...
        <nav-menu-link title="Error" :to="{ name: 'notfound' }" target="_blank"></nav-menu-link>
      </nav-menu-group>
      <nav-menu-section-title title="Other Example"></nav-menu-section-title>
      ...
      <nav-menu-link title="Tables" :to="{ name: 'tables' }" :icon="icons.mdiTable"></nav-menu-link>
      <nav-menu-link title="Cards" :to="{ name: 'cards' }" :icon="icons.mdiCreditCardOutline"></nav-menu-link>
      <nav-menu-link title="Forms" :to="{ name: 'forms' }" :icon="icons.mdiFormSelect"></nav-menu-link>
    </v-list>
  </v-navigation-drawer>
</template>
